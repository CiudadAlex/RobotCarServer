...
class Text2SpeechEnginePyttsx3Impl:

    instance = None

    @staticmethod
    def get_instance():
        if Text2SpeechEnginePyttsx3Impl.instance is None:
            Text2SpeechEnginePyttsx3Impl.instance = Text2SpeechEnginePyttsx3Impl("en")
        return Text2SpeechEnginePyttsx3Impl.instance
